...
<head>
    ...
    <script src="{views:/jquery-1.7.2.min.js}" type="text/javascript" language="javascript"></script>
...
<div class="pro_main">
    ...
    <!-- <div class="pro_cen">
        ...
        <div class="pro_cen">
            <ul class="main_centon">
                <li class="tit_left">
                    <a href="" title="推荐"><img class="pz_img" src="{views:images/icon/icon_tj.png}"></a>
                    <span>两切低合金板</span>
                </li>
        ...
        <div class="page_width" style="_margin-top: -15px; position: static;">
            ...
            <div id="footer">
                ...
                <div class="cd-popup" role="alert">
                    <div class="cd-popup-container">
                        ...
                        <a class="cd-popup-close"><img class="pop_qx" src="{views:images/icon/icon_qx.jpg}"/></a>
                        <!-- 把要轮播的地方写上来 -->
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="{views:images/banner/01.jpg" a}lt="First slide">
                </div>
                <div class="item">
                    <img src="{views:images/banner/02.jpg" a}lt="Second slide">
                </div>
                <div class="item">
                    <img src="{views:images/banner/03.jpg" a}lt="Third slide">
                </div>
            </div>
            <!-- 轮播（Carousel）导航 -->
