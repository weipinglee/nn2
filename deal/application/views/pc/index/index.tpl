...
<div id="index_logo">
    <div class="page_width">
        ...
        <div class="searchbox">
            ...
            <div class="bodys">
                <p class="keyword_0"><input type="text" onblur="if (this.value == '') {this.value = '高铝砖 乙醇 PP';}" onfocus="if (this.value == '高铝砖 乙醇 PP') {this.value = '';}" value="高铝砖 乙醇 PP" id=""  /><a href="product.html"><button class="one1">搜索</button></a></p>
               <!-- <p class="keyword_1"><input type="text" onblur="if (this.value == '') {this.value = '乙醇 PP 高铝砖';}" onfocus="if (this.value == '乙醇 PP 高铝砖') {this.value = '';}"  value="乙醇 PP 高铝砖" id=""  /><a href="product.html"><button class="two2">搜索</button></a></p>
            --></div>
        </div>
...
<div class="floor_left_box" id="floornav" data-tpa="YHD_HOMEPAGE_FLOORNAV" style="display:none;">
    ...
    <a href="#floor-1" data="#floor-1" rel="floor-1" class="cur">
        <i class="left_iconfont "><img src="images/floor_07.png">交易市场</i>
        <em class="two_line"><img src="images/floor_cur_07.png">交易市场</em>
    </a>
    <a href="#floor-2" data="#floor-2" rel="floor-2">
        <i class="left_iconfont "><img src="images/floor_09.png">市场指数</i>
        <em class="two_line"><img src="images/floor_cur_09.png">市场指数</em>
    </a>
    <a href="#floor-3" data="#floor-3" rel="floor-3">
        <i class="left_iconfont "><img src="images/floor_03.png" >推荐商家</i>
        <em class="two_line"><img src="images/floor_cur_03.png">推荐商家</em>
    </a>
    <a href="#UniSwfStore_uniswfstore_0" data="#toTop" rel="toTop">
        <i class="left_iconfont "><img src="images/floor_08.png">返回顶部</i>
        <em class="two_line"><img src="images/floor_cur_08.png">返回顶部</em>
    </a>
