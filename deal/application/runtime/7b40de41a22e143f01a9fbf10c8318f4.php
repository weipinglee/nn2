...
<!------------------公用头部控件 开始-------------------->
    ...
    <div id="mainContent" style="background:#FFF;"> 
        ...
        <div class="page_width">
            ...
            <form method="post" action='http://localhost/nn2/deal/public/offers/buyerpay'>
            <div class="checkim">
                 ...
                 <span class="qingorder"><b class="shangpqd">商品信息</b><h3>
                     ...
                     <div class="bezel_clear">
                         ...
                         <div class="module_clear">
                             ...
                             <a href="javascript:;"><img src="http://localhost/nn2/deal/public/views/pc/images/order/dp-4.jpg" width="80" height="80" alt="产品"> </a>
                             <a href="javascript:;"><div class="clear_word">
                                 <h5><?php echo isset($data['name'])?$data['name']:"";?></h5>
                                 <p>品牌：诗茗化工</p>
                                 <p>规格/纯度：≥98% &nbsp; 起订量：<?php echo isset($data['minimum'])?$data['minimum']:"";?><?php echo isset($data['unit'])?$data['unit']:"";?></p>
                             </div></a>
                             <span class="shulag"> <?php echo isset($data['num'])?$data['num']:"";?> </span>
           ...
           <span class="jiesim"><b>结算信息</b><h3>  </h3> </span>
            ...
            <span class="daizfji"><span class="zhifjin">待支付金额：</span><i>￥</i><b><?php echo isset($data['pay_deposit'])?$data['pay_deposit']:"";?></b></span>
               ...
               <input type="hidden" name="num" value="<?php echo isset($data['num'])?$data['num']:"";?>" />
