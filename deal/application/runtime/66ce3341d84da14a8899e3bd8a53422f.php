...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv = "X-UA-Compatible" content = "IE=edge,chrome=1" /><title>
    ...
    <script src="/nn2/deal/public/views/pc/js/jquery-1.7.2.min.js" type="text/javascript" language="javascript"></script>
    ...
    <script src="/nn2/deal/public/views/pc/js/index20141027.js" type="text/javascript"></script>
    <script type="text/javascript" src="/nn2/deal/public/views/pc/js/product_details_js.js"></script>
    ...
    <script type="text/javascript" src="/nn2/deal/public/js/layer/extend/layer.ext.js"></script>
 ...
 <div class="login_top">
    <ul class="w1200">
      <ul class="topnav_left">
        <li><a href="http://localhost/nn2/deal/public//list/:name-:value/"><img class="shouy mobil" src="/nn2/deal/public/views/pc/images/password/shouy.png">耐耐网首页</a></li>
        <li class="space">
          <?php if($username){?>您好，
      ...
      <ul >
        ...
        <!-- <li><a href=""><img class="shouy mobil" src="/nn2/deal/public/views/pc/images/password/mobile.png">手机版</a><i>|</i></li> -->
        ...
        <div class="logoimg_left">
         ...
         <div class="logoimg_box">
           <div class="sure_order">
            <img class="" src="/nn2/deal/public/views/pc/images/password/small_1s.png"> 
            <p>确认订单</p>
           </div>
            <div class="pay_order">
            <img class="" src="/nn2/deal/public/views/pc/images/password/small_2h.png"> 
            <p>支付货款</p>
           </div>
            <div class="plete_order">
            <img class="" src="/nn2/deal/public/views/pc/images/password/small_3h.png"> 
            <p>支付完成</p>
           </div>
         </div>
...
<form method="post" <?php if($data['show_payment']){?>pay_secret="1"<?php }?> auto_submit="1" action='http://localhost/nn2/deal/public/trade/buyerpay?callback=http://localhost/nn2/deal/public/offers/check/id/<?php echo $data['id'];?>/pid/<?php echo $data['product_id'];?>'>
                   ...
                   <div class="yListr bank">
                     ...
                     <div class="bank_box" style="display:none;">
                      <!--  <label for=""><input type="radio" name="bank"/></label><img src="/nn2/deal/public/views/pc/images/password/bank_js.png" alt="" />
                        ...
                        <label for=""><input type="radio" name="bank"/></label><img src="/nn2/deal/public/views/pc/images/password/bank_pa.png" alt="" /> -->
                        
                        <label for=""><input type="radio" checked="checked" name="bank"/></label><img src="/nn2/deal/public/views/pc/images/password/bank_zx.png" alt="" />
                     </div>
             <script>
                 $(function(){
