                                    ...
                                    <p class="fenlei-h1"><?php echo isset($item['name'])?$item['name']:"";?></p><p class="fenlei">
                                        ...
                                        <?php for($num = 0 ; $num<=2 ; $num = $num+1){?>
                                            <?php if(isset($item['nested'][$num]['id'])){?>
                                                <a href="http://localhost/nn2/deal/public/offers/offerlist/cate/<?php echo $item['nested'][$num]['id'];?>"><?php echo isset($item['nested'][$num]['name'])?$item['nested'][$num]['name']:"";?></a>&nbsp;
                                            <?php }?>
                                        <?php }?>
                                ...
                                <div class="item-list clearfix" style="top: 1px; display: none;">
                                    ...
                                    <div class="subitem">
                                        <?php if(!empty($item['nested'])) foreach($item['nested'] as $kk => $item){?>
                                            <?php if($kk<=11){?>
                                            <dl class="fore1">
                                                <dt><a href="http://localhost/nn2/deal/public/offers/offerlist/cate/<?php echo $item['id'];?>"><?php echo isset($item['name'])?$item['name']:"";?></a></dt>

                                                <dd>
                                                    <?php if(!empty($item['nested'])) foreach($item['nested'] as $key => $item){?>
                                                        <em><a href="http://localhost/nn2/deal/public/offers/offerlist/cate/<?php echo $item['id'];?>"><?php echo isset($item['name'])?$item['name']:"";?></a></em>
                                                    <?php }?>
                                                </dd>
                                            </dl>
                                            <?php }?>
...
<!--   分类js 隐藏 end -->
 ...
 <!-- 分类结束 -->
    ...
    <script type="text/javascript" src="/nn2/deal/public/views/pc/js/area/AreaData_min.js" ></script>
<script type="text/javascript" src="/nn2/deal/public/views/pc/js/area/Area.js" ></script>
            <script src="/nn2/deal/public/views/pc/js/roll.js"></script>
    <link rel="stylesheet" type="text/css" href="/nn2/deal/public/views/pc/css/roll.css">
    <link rel="stylesheet" type="text/css" href="/nn2/deal/public/views/pc/css/user_index.css">
    <!-- 轮播图end-->
<script type="text/javascript" src="/nn2/deal/public/js/arttemplate/artTemplate.js"></script>
    <link rel="stylesheet" type="text/css" href="/nn2/deal/public/views/pc/css/font-awesome.min.css">

    <link rel="stylesheet" type="text/css" href="/nn2/deal/public/views/pc/css/product.css">
    <link rel="stylesheet" type="text/css" href="/nn2/deal/public/views/pc/css/style_main.css">
        <style>
    .page_num {
      margin-top:  12px;
    }
 ...
 <!------------------导航 开始-------------------->
           ...
           <div class="pro_classify">
            ...
            <div class="clearfix cla_sty">
                <input type="hidden" name="attr_url" value="http://localhost/nn2/deal/public/offers/ajaxgetcategory"  />
               <input type="hidden" name="sort" value="default" />
                <input type="hidden" name="img_url" value="/nn2/deal/public/views/pc/"  />
...
<div class="pro_main">
    ...
    <!--
        ...
        <!-- 温馨提示end-->
            ...
            <script src="/nn2/deal/public/views/pc/js/product/attr.js"></script>
           ...
           <script type="text/html" id="productTemplate">
               ...
               <div class="pro_cen">
                   <ul class="main_centon">
                       <li class="tit_left">
                           <!--<a title="品质保证"><img class="pz_img" src="/nn2/deal/public/views/pc/images/icon/icon_pz.png"></a>-->
                       ...
                       <a title="已投保"><img class="icon_img" src="/nn2/deal/public/views/pc/images/icon/icon_yb.png"/></a>
                       <% } else { %>
                       <a title="未投保"><img class="icon_img" src="/nn2/deal/public/views/pc/images/icon/icon_wb.png"/></a>
                       <% }%>
                           <a title="认证"><img class="icon_img" src="/nn2/deal/public/views/pc/images/icon/icon_rz.png"/></a>
                       </li>
                       <li class="but_left">
                           <div class="">
                               <div >
                               <% if (data[i].jiao==0){ %>
                                    <% if (data[i].qq){ %>
                                   <a href="tencent://message/?uin=<%=data[i].qq%>&Site=qq&Menu=yes"><img style="vertical-align:middle;" src="/nn2/deal/public/views/pc/images/icon/QQ16X16.png" class="ser_img" alt="联系客服"/>
                                   </a>
                                     <% }else{%>
                                     <img style="vertical-align:middle;" src="/nn2/deal/public/views/pc/images/icon/QQgray16X16.png" class="ser_img"/>
                                     <% }%>
                                   <% if (data[i].type==1){ %>
								    
                                   <a href="http://localhost/nn2/deal/public/offers/offerdetails/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;" src="/nn2/deal/public/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/></a>
								   <a href="http://localhost/nn2/deal/public/trade/check/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;"  src="/nn2/deal/public/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="下单"/></a>
                                    <% } else { %>
									<a href="http://localhost/nn2/deal/public/offers/purchasedetails/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;"  src="/nn2/deal/public/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/></a>
								   <a href="http://localhost/nn2/deal/public/trade/report/id/<%=data[i].id%>" ><img style="vertical-align:middle;"  src="/nn2/deal/public/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="报价"/></a>
                                 

                                   <% }%>
                                   <% } else { %>
                                   <img style="vertical-align:middle;" src="/nn2/deal/public/views/pc/images/icon/bg_ycj.png" class="ser_img_1"/>
                                   <% }%>
                               </div>
                               <ul>
