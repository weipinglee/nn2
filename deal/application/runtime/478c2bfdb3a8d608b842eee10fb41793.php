...
<!------------------公用头部控件 开始-------------------->
    ...
    <div id="index_nav">
        <div class="page_width">
            ...
            <ul class="nav n_nav">
                <li class="current"><a href="http://localhost/nn2/deal/public/index/index">首页</a></li>
                <li><a href="http://localhost/nn2/deal/public/offers/offerlist" target="_blank">交易中心</a></li>
            </ul>
        </div>
    </div>
    <!------------------导航 开始-------------------->
