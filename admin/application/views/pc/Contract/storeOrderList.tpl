...
<script type="text/javascript" src="{views:js/validform/formacc.js}"></script>
        <div id="content" class="white">
            <h1><img src="{views:img/icons/posts.png}" alt="" /> 交易管理</h1>
<div class="bloc">
    <div class="title">
        待审核出库列表
    </div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		{foreach:items=$data}
			<tr class="text-c">
				...
				<td class="td-manage">
				 <a title="通过" href="javascript:;" ajax_status=1 to_list=1 ajax_url="{url:/trade/contract/storeOrderPass}id/{$item['delivery_id']}" class="ml-5" style="text-decoration:none">通过</a></td>
			</tr>
		{/foreach}
		</tbody>
