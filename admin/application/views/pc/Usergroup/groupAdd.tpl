...
<div class="bloc">
   ...
   <div class="pd-20">
  <form action="{url:/member/usergroup/groupAdd}" method="post" class="form form-horizontal" id="form-usergroup-add" auto_submit redirect_url = "{url:/member/usergroup/groupList}">
    <div class="row cl">
