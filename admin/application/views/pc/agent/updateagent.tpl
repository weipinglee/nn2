...
<div class="bloc">
   ...
   <div class="pd-20">
  <form action="{url:member/agent/updateAgent}" method="post" class="form form-horizontal" id="form-member-add" auto_submit redirect_url="{url:member/agent/agentList}">
    <div class="row cl">
