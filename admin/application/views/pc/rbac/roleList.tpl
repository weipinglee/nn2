...
<div class="bloc">
    ...
    <div class="content">
        <div class="pd-20">
	 <div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-primary radius" href="{url:/system/rbac/roleAdd}"><i class=" icon-plus"></i> 添加分组</a> </span>  </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		{foreach:items=$data}
			<tr class="text-c">
				...
				<td class="td-manage">
					{if:$item['status'] == 0}
					<a style="text-decoration:none" href="javascript:;" title="停用" ajax_status=1 ajax_url="{url:/system/rbac/setStatus}id/{$item['id']}"><i class="icon-pause"></i></a>
