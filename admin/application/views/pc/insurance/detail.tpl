...
<div class="bloc">
 ...
 <div class="pd-20">
  <form action="{url:Trade/Insurance/detail}" method="post" class="form form-horizontal" id="form-user-add" auto_submit redirect_url="{url:Trade/Insurance/insuranceList}">
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>保险产品名称：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="{if:isset($data['name'])}{$data['name']}{/if}" datatype="s1-20" errormsg="请正确填写属性名" placeholder="" name="name">
      </div>
      <div class="col-5"> </div>
    </div>
      <div class="row cl">
      ...
      <div class="row cl">
          ...
          <div class="formControls col-5">
              <input type="text" class="input-text" ignore="ignore" datatype="s1-20"  value="{if:isset($data['code'])}{$data['code']}{/if}" placeholder="" name="code">
          </div>
          <div class="col-5"> </div>
      </div>
...
<div class="row cl" id="rate">
      ...
      <div class="row cl">
          ...
          <div class="formControls col-5">
              <input type="radio" name="type" class="mode" value="1" {if: $data['mode'] == 1} checked="true" {/if}>比例<input type="radio" class="mode" name="type" value="2"  {if: $data['mode'] == 2} checked="true" {/if}>定额
          </div>
          <div class="col-5"> </div>
      </div>
          ...
          <div class="col-5"> </div>
            ...
            <div class="row cl" id="fee"  {if: $data['mode'] == 1} style="display:none;" {/if}>
         ...
         <div class="row cl">
          ...
          <div class="formControls col-5">
              <input type="radio" name="status"  value="0"  {if: $data['status'] == 0} checked="true" {/if}>关闭<input type="radio"  name="status" value="1" {if: $data['status'] == 1} checked="true" {/if}> 开启
          </div>
          <div class="col-5"> </div>
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="note" cols="" rows="" class="textarea"  placeholder="说点什么..." datatype="*0-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)">{if:isset($data)}{$data['note']}{/if}</textarea>
      </div>
      <div class="col-5"> </div>
    </div>
    <div class="row cl">
