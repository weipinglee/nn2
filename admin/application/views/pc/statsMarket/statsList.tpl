		...
		{foreach:items=$data}
			<tr class="text-c">
				...
				<td class="td-manage">
					...
					<a title="删除" href="javascript:;" ajax_status=-1 ajax_url="{url:information/statsMarket/delStats}?id={$item['id']}" class="ml-5" style="text-decoration:none"><i class="icon-trash fa-trash"></i></a>
                </td>
			</tr>
		{/foreach}
		</tbody>
