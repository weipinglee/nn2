        ...
        <div class="pd-20">
            ...
            <form action="{url:system/friendlyLink/addFrdLink}" method="post" class="form form-horizontal" id="form-member-add" auto_submit redirect_url="{url:system/friendlyLink/frdLinkList}">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-5">
                        <input type="text" name="link" size="80" class="input-text" datatype="s2-50" nullmsg="链接不能为空">
                    </div>
                    <div class="col-4"> </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-5">
                        <input type="text" name="order" value="100" class="input-text" datatype="s2-20"  errormsg="请填写排序">排序字段为数字,越小越靠前
                    </div>
                    <div class="col-4"> </div>
                </div>
                <div class="row cl">
