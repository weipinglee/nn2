 ...
 <div class="pd-20">
	 <form action="{url:member/certManage/doDealerCert}" method="post" class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="{$cert['username']}" placeholder="" id="user-name" name="user-name" datatype="*2-16" nullmsg="用户名不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text"  autocomplete="off" value="{$cert['mobile']}" class="input-text" >
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text"  autocomplete="off" class="input-text"  value="{$cert['email']}" name="email">
			</div>
			<div class="col-4"> </div>
		</div>
	 {if:$cert['type']==0}
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text"  autocomplete="off" value="{$cert['true_name']}" class="input-text" >
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text"  autocomplete="off" class="input-text"  value="{$cert['identify_no']}" >
			</div>
			<div class="col-4"> </div>
		</div>
	 ...
	 {else:}
		 <div class="row cl">
			 ...
			 <div class="formControls col-5">
				 <input type="text"  autocomplete="off" value="{$cert['company_name']}" class="input-text" >
			 </div>
			 <div class="col-4"> </div>
		 </div>
		 <div class="row cl">
