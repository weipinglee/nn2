...
<div class="bloc">
    ...
    <div class="content">
        <div class="pd-20">
            ...
            <div class="zhannei">
             <form action="{url:/guide/addGuide}" method="post" class="form form-horizontal" id="form-user-character-add">
                ...
                <div class="row cl">
                 ...
                 <div class="row cl">
                    ...
                    <div class="formControls col-10">
                        ...
                        <input type="radio" name="type" onclick="changeGuideCategory({$key}, '{url:/guide/ajaxGetGuideCategory}')" value="{$key}" {if: $key==0}checked="true"{/if}><span>{$value}</span>
                        {/foreach}
