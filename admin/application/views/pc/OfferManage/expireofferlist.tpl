            ...
            {foreach:items=$data}
                <tr class="text-c">
                    ...
                    <td>{if:$item['is_del']==1}已删除{else:}正常{/if}</td>
                     <td class="td-manage"> <a title="查看" href="{url:trade/OfferManage/expireOfferDetails?id=$item['id']&user=$item['username']}" class="ml-5" style="text-decoration:none"><i class="icon-eye-open"></i></a></td>
                </tr>
           {/foreach}
        </tbody>
    </table>
