        ...
        <div id="content" class="white">
            <h1><img src="{views:img/icons/dashboard.png}" alt="" />编辑收费会员分组
</h1>
...
<div class="bloc">
   ...
   <div class="pd-20">
  <form action="{url:/member/payusergroup/groupEdit}" method="post" class="form form-horizontal" id="form-usergroup-edit" auto_submit redirect_url = "{url:/member/payusergroup/groupList}">
    <div class="row cl">
