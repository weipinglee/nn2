        ...
        <div class="pd-20">
            ...
            <form action="{url:member/companyRec/recAdd}" method="post" class="form form-horizontal" id="form-member-add" auto_submit redirect_url="{url:member/companyRec/recList}">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-5">
                        <input type="text" name="start_time" value="{$data['start_time']}" class="Wdate addw" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',startDate:'%y',minDate:'%y-%M-#{%d}'});">
                    </div>
                    <div class="col-4"> </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-5">
                        <input type="text" name="end_time" value="{$data['end_time']}" class="Wdate addw" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" >
                    </div>
                    <div class="col-4"> </div>
                </div>
                <div class="row cl">
