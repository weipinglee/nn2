        ...
        <div id="sidebar">
            <ul>
                ...
                <li><a href="#" target="content"><img src="http://localhost/nn2/admin/public/views/pc/img/icons/menu/brush.png" alt="" />交易管理</a>
                    <ul>
                        <li><a href="goods-list.html" target="content">产品分类设置</a></li>
                ...
                <li class="nosubmenu"><a href="modal.html" class="zoombox w450 h700" target="content"><img src="http://localhost/nn2/admin/public/views/pc/img/icons/menu/comment.png" alt="" /> 仓库管理</a></li>
            </ul>
