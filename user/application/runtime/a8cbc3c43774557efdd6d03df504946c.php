                                ...
                                <?php foreach($data as $key => $item){?>
									<tr class="title">
										<td colspan="6">
											...
											单号:<a href="http://localhost/nn2/user/public/contract/sellerdetail/id/<?php echo $item['id'];?>"><span class="col2517EF"><?php echo isset($item['order_no'])?$item['order_no']:"";?></span></a>
											<span class="colaa0707 ht_padd"></span>
											<span><img class="middle_img" src="http://localhost/nn2/user/public/views/pc/images/center/ico_cj.jpg"><?php if($item['company_name']){?>购买单位：<?php echo isset($item['company_name'])?$item['company_name']:"";?><?php }else{?>购买个人：<?php echo isset($item['true_name'])?$item['true_name']:"";?><?php }?></span>
											<span class="ht_padd">
										...
										<td>
											...
											<div class="div_heights">
												<?php if($item['action_href']){?>
													<a href='<?php echo isset($item['action_href'])?$item['action_href']:"";?>'><b><?php echo isset($item['action'])?$item['action']:"";?><b></a>
												<?php }else{?>
