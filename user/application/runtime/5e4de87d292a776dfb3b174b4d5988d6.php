...
<script type="text/javascript" >
  var logPath = 'http://localhost/nn2/user/public/login/dolog';
</script>
  ...
  <div class="container">
    <div class="register-box">
      ...
      <div class="reg-form" id="js-form-mobile"> <br>
       ...
       <a id='chgCode' href="javascript:void(0)" onclick="changeCaptcha('http://localhost/nn2/user/public/login/getcaptcha',$(this).find('img'))"><img src="http://localhost/nn2/user/public/login/getcaptcha" /></a>
        </div>
        <div class="bottom">
          <a id="js-mobile_btn" href="javascript:void(0);" class="button btn-green" onclick="double_submit()"> 立即登录</a>
        </div>
		<div class="mm_reg"><a href="http://localhost/nn2/user/public/login/passwordreset">忘记密码</a><a href="http://localhost/nn2/user/public/login/register">注册>></a></div>
      </div>
    </div>
  </div>
</div>
