...
<div class="user_c">
	<div class="user_zhxi">
		<div class="zhxi_tit">
			<p><a>账户管理</a>><a><?php if(!empty($pay_secret)){?>修改支付密码<?php }else{?>设置支付密码<?php }?></a></p>
		</div>
		<div style="float:left">
			<form action="http://localhost/nn2/user/ucenter/paysecret" auto_submit redirect_url="http://localhost/nn2/user/ucenter/baseinfo">
				<?php if(!empty($pay_secret)){?>
					<div class="zhxi_con">
						<span class="con_tit"><i>*</i>原支付密码：</span>
						<span><input class="text" type="password"  name="ori_secret" datatype='*6-10' errormsg='6-10位支付密码'/>
							<span>忘记原密码？试试<a style="color:#0088cc;" href="http://localhost/nn2/user/ucenter/paysecrets">申诉找回</a></span>
					</div>
					<div class="zhxi_con">
