		...
		<div class="user_b">
			...
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="xx_top">
							<form action="http://localhost/nn2/user/public/managerdeal/productlist" method="GET" name="">
								<ul>
						...
						<div class="xx_center">
							<table border="0"  cellpadding="" cellspacing="">
								...
								<tr>
									...
									<td><a href="http://localhost/nn2/user/public/managerdeal/productdetail/id/<?php echo $list['id'];?>">查看</a></td>
								</tr>
								<?php }?>
