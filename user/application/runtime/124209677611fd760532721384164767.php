				...
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="de_ce">
							...
							<form action="http://localhost/nn2/user/public/storedelivery/storefees" method="post" auto_submit pay_secret="1" redirect_url="http://localhost/nn2/user/public/delivery/deliselllist">
