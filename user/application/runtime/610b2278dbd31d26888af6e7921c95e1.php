				...
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="de_ce">
							...
							<div class="detail_chj">
								<a  href="http://localhost/nn2/user/contract/contract/order_id/<?php echo $info['id'];?>" target='_blank'><input class="fk_butt"  type="button" value="合同预览"/></a>
								...
								<?php if(!empty($info['action'])) foreach($info['action'] as $key => $item){?>
									...
									<a href="<?php echo isset($item['url'])?$item['url']:"";?>" <?php if($item['confirm']){?>confirm=1<?php }?>><input class="fk_butt" type="button" value="<?php echo isset($item['action'])?$item['action']:"";?>"/></a><?php }?>
								<?php }?>
						...
						<div class="sjxx">
							...
							<div class="sj_detal">
								...
								<span>&nbsp;<?php echo isset($info['seller_name'])?$info['seller_name']:"";?></span>
							</div>
							<div class="sj_detal">
						...
						<div class="sjxx">
							...
							<div class="sj_detal">
								...
								<span>&nbsp;<img src="<?php echo isset($invoice['order_invoice']['image'])?$invoice['order_invoice']['image']:"";?>"></span>
							</div>
							<div class="sj_detal">
