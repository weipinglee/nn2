...
<script type="text/javascript" src="http://localhost/nn2/user/public/views/pc/js/user_index.js"></script>
	<div class="user_body">
		<div class="user_b">
			<div class="user_l">
				<div class="wrap_con">
			...
			<div class="user_c">
				...
				<div class="check-approve">
					<img src="http://localhost/nn2/user/public/views/pc/images/icon/check-approve.jpg">
					<p class="p-title zn-f18">据说，通过业务认证后，我在耐耐就是有照驾驶了！</p>
					<p class="p-con  zn-f14">93.8%的注册用户选择进行认证。“业务认证”你值得拥有！</p>
					<p class="p-btn">
						<a href="zh_rez.html" class="zn-f16 go-now">资质认证</a>
			...
			<!-- start 暂不认证 -->	
				<div class="user_zbrz noshow">
					<div class="user_nrz">
						<div class="nrz_tit"><span>我的订单</span><a class="gengduo" href="user_dd.html">更多>></a></div>
						<div class="nrz_dd">
							<table width="100%">
								<tr>
									<td>
										<a><img src="http://localhost/nn2/user/public/views/pc/images/banner/551b861eNe1c401dc.jpg"/></a>
									</td>
									<td>
										<p>皇甫静</p>
									</td>
					...
					<div class="user_nrz">
						<div class="nrz_tit"><span>我的推荐</span><a class="gengduo" href="user_gz.html">更多>></a></div>
						<div class="nrz_gz">
							<table width="100%">
								<tr>
									<td>
										<a><img src="../images/banner/551b861eNe1c401dc.jpg"/>
											<p>￥2000</p>
										</a>
									</td>
									<td>
