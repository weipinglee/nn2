		...
		<div class="user_b">
			...
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="xx_top">
							<form action="http://localhost/nn2/user/purchase/lists" method="GET" name="">
								<ul>
						...
						<div class="xx_center">
							<table border="0"  cellpadding="" cellspacing="">
								...
								<tr>
									...
									<td><?php echo isset($list['quantity'])?$list['quantity']:"";?></td>
									<td><?php echo isset($list['unit'])?$list['unit']:"";?></td>
									<td><?php echo isset($list['price_l'])?$list['price_l']:"";?>-<?php echo isset($list['price_r'])?$list['price_r']:"";?></td>
									<!-- <td>已投保</td> -->
									<td><span class="col000000"><?php echo isset($list['status_txt'])?$list['status_txt']:"";?></span></td>
									<td><?php echo isset($list['apply_time'])?$list['apply_time']:"";?></td>
									<td>
										<a href="http://localhost/nn2/user/purchase/detail/id/<?php echo $list['id'];?>">查看</a>
										<?php if($list['status'] == \nainai\offer\product::OFFER_OK){?>
											<a href="http://localhost/nn2/user/purchase/reportlists?id=<?php echo isset($list['id'])?$list['id']:"";?>">报价列表</a>
										<?php }?>
										<!-- <a href="http://localhost/nn2/user/purchase/doapply/id/<?php echo $list['id'];?>">审核</a> -->
									</td>
								</tr>
								<?php }?>
