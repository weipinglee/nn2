                    ...
                    <div class="list_names">
						...
						<table border="0">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <?php echo isset($info['amount'])?$info['amount']:"";?>
                                </td>
                            </tr>
                             <tr>
                                <td nowrap="nowrap"><span></span>购买人：</td>
                                <td colspan="2">
                                    <?php echo isset($info['buyer_name'])?$info['buyer_name']:"";?>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="btn">
                                ...
                                <a href="http://localhost/nn2/user/public/order/sellerverify/order_id/<?php echo $info['id'];?>" confirm>确认质量</a>
