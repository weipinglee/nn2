...
<script type="text/javascript" src='/nn2/user/js/upload/upload.js'></script>
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div>
						<form action="http://localhost/nn2/user/fund/zxpage"  method='post' auto_submit>
							

							</div>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>附属账户名称：</span>
								<span><input class="text" type="text" datatype="zh2-10" nullmsg="填写附属账户名称" name="name" value="<?php echo isset($info['name'])?$info['name']:"";?>"></span>
								<span></span>
					...
					<?php if($info['no']){?>
						<div class="zhxi_con">
							...
							<span><input class="text" type="text" value="<?php echo isset($info['no'])?$info['no']:"";?>"></span>
							<span></span>
						</div>
					<?php }?>
					...
					<div class="zhxi_con">
								...
								<span><input class="text" type="text" datatype="zh2-10" nullmsg="填写法人名称" name="legal" value="<?php echo isset($info['legal'])?$info['legal']:"";?>"></span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span>
									<input class="text" type="text" name="id_card" datatype="/^\d{15,18}$/i" value="<?php echo isset($info['id_card'])?$info['id_card']:"";?>" />
								</span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span><input class="text" type="text" name="address" datatype="*" value="<?php echo isset($info['address'])?$info['address']:"";?>" /></span>
								<span></span>
								
							</div>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>联系人姓名：</span>
								<span><input class="text" type="text" name="contact_name" datatype="*" value="<?php echo isset($info['contact_name'])?$info['contact_name']:"";?>" /></span>
								<span></span>
								
							</div>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>联系电话：</span>
								<span><input class="text" type="text" name="contact_phone" datatype="*" value="<?php echo isset($info['contact_phone'])?$info['contact_phone']:"";?>" /></span>
								<span></span>
								
							</div>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>电子邮箱：</span>
								<span><input class="text" type="text" name="mail_address" datatype="*" value="<?php echo isset($info['mail_address'])?$info['mail_address']:"";?>" /></span>
								<span></span>
...
<script type="text/javascript">
	...
	$(function(){
		if(<?php echo isset($info['user_id'])?$info['user_id']:"";?>){
