...
<img src="http://localhost/nn2/user/public/views/pc/images/mid_banner/banner_01.png" style="position: fixed;
  ...
  <div>
    http://localhost/nn2/user/public/index/doreg
    <div class="register">
      <div class="reg_top">
      ...
      <div class="reg_cot gr_reg">
        <input name="checkUrl" value="http://localhost/nn2/user/public/index/checkisone" type="hidden"/>
        <form action="http://localhost/nn2/user/public/index/doreg" method="post">
