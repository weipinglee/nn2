		...
		<div class="user_b">
			...
			<div class="user_c_list">
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="xx_top">
							<form action="http://localhost/nn2/user/public/index.php//contract/depositlist" method="post" name="">
								<ul>
                                ...
                                <?php foreach($data as $key => $item){?>
									<tr class="title">
										<td colspan="6">
											...
											单号:<span class="col2517EF"><?php echo isset($item['order_no'])?$item['order_no']:"";?></span>
											<span class="colaa0707 ht_padd"></span>
											<span><img class="middle_img" src="http://localhost/nn2/user/public/views/pc/images/center/ico_cj.jpg">生成厂家：北京东峰兴达耐火材料有线公司</span>
											<span class="ht_padd">
