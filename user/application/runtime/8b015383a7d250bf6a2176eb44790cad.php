					...
					<div class="chp_xx">
						<div class="de_ce">
							<div class="detail_chj" style="margin-top: 11px">
								...
								<a href="http://localhost/nn2/user/public/managerstore/storedeliverycheck/id/<?php echo $info[id];?>" style="background: #FC7300;padding: 8px 15px;color:#fff;text-decoration: none">确认出库</a>
							</div>
						</div>
						<div class="sjxx">
							<p>仓库信息</p>
