									...
									<td>重量</td>
                                                                                ...
                                                                                <td>操作</td>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <a href='http://localhost/nn2/user/managerstore/applystorecheck/id/<?php echo $list["id"];?>'>审核</a>
                                                                                                <?php }elseif($list['status'] == 21 ){?>
                                                                                                <a href='http://localhost/nn2/user/managerstore/applystoresign/id/<?php echo $list["id"];?>'>签发</a>
                                                                                                <?php }else{?>
                                                                                                <a href='http://localhost/nn2/user/managerstore/applystoredetail/id/<?php echo $list["id"];?>'>查看</a>
                                                                                                <?php }?></td>
                                                                                        </tr>
                                                                                      <?php }?>
							</table>
