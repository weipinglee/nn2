									...
									<td>重量</td>
                                                                                ...
                                                                                <td>操作</td>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td><?php echo isset($list['quantity'])?$list['quantity']:"";?>(<?php echo isset($list['unit'])?$list['unit']:"";?>)</td>
                                                                                                ...
                                                                                                <td><a href='http://localhost/nn2/user/public/managerstore/applystorecheck/id/<?php echo $list["id"];?>'>审核</a></td>
                                                                                                <?php }elseif($list['status'] == 21 ){?>
                                                                                                <td><a href='http://localhost/nn2/user/public/managerstore/applystoresign/id/<?php echo $list["id"];?>'>签发</a></td>
																								<?php }else{?>
																									<td><a href='http://localhost/nn2/user/public/managerstore/applystoredetail/id/<?php echo $list["id"];?>'>查看</a></td>
                                                                                                <?php }?>
                                                                                        </tr>
                                                                                      <?php }?>
							</table>
