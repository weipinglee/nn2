...
<div class="header">
	...
	<div class="user_body">
		<div class="user_b">
            ...
            <!--end左侧导航-->
            <div id="cont"><style type="text/css">
...
<div id='verify'>
	<p>扣减金额：&emsp;<?php echo isset($data['reduce_amount'])?$data['reduce_amount']:"";?></p>
	<p>说明&emsp;&emsp;：&emsp;<?php echo isset($data['reduce_remark'])?$data['reduce_remark']:"";?></p>

  <a href="http://localhost/nn2/user/public/order/sellerverify/order_id/<?php echo $data['id'];?>" confirm>同意</a> 
	<a href="http://localhost/nn2/user/public/order/sellerverify/order_id/<?php echo $data['id'];?>/disagree/1" confirm>不同意</a>	
</div>   </div>
