					...
					<div class="chp_xx">
						<div class="de_ce">
							...
							<div class="" style="line-height: 25px">
								<?php foreach($info['pay_log'] as $key => $item){?>&nbsp;&nbsp;
							...
							<div class="detail_chj">
								...
								<?php if($info['action_href']){?><input class="fk_butt" type="button" onclick="window.location.href='<?php echo isset($info['action_href'])?$info['action_href']:"";?>'" value="<?php echo isset($info['action'])?$info['action']:"";?>"/><?php }?>
							</div>
						</div>
						<div class="sjxx">
							<p>收件人信息</p>
							<div class="sj_detal">
								...
								<span>&nbsp;<?php echo isset($info['userinfo']['type'])?$info['userinfo']['type']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">名称：</b>
								<span>&nbsp;<?php echo isset($info['userinfo']['true_name'])?$info['userinfo']['true_name']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">地址：</b>
								<span id='area'>&nbsp;                <script type="text/javascript">
                 areaObj = new Area();

                  $(function () {
                    var text = areaObj.getAreaText('<?php echo $info['userinfo']['area'] ; ?>',' ');
                    $('#area').html(text);
                  });
                </script>
						...
						<div class="xx_center">
							<table border="0" cellpadding="" cellspacing="">
								...
								<tr>
									<td><img src="http://localhost/nn2/user/public/views/pc/images/banner/551b861eNe1c401dc.jpg"/></td>
