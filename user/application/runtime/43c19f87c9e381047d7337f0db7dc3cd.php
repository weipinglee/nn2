						...
						<div class="sjxx">
							...
							<form action="http://localhost/nn2/user/contract/geneorderinvoice" method="post" auto_submit rediret_url="http://localhost/nn2/user/contract/sellerdetail/id/<?php echo $info['id'];?>">
								...
								<div class="sj_detal">
									...
									<span>&nbsp;<?php if($invoice['order_invoice']['post_company']){?><?php echo isset($invoice['order_invoice']['post_company'])?$invoice['order_invoice']['post_company']:"";?><?php }else{?><input type="text" name="post_company" datatype='*'/><?php }?></span>
								</div>
								<div class="sj_detal">
									<b class="sj_de_tit"><span>*</span>邮寄单号：</b>
									<span>&nbsp;<?php if($invoice['order_invoice']['post_no']){?><?php echo isset($invoice['order_invoice']['post_no'])?$invoice['order_invoice']['post_no']:"";?><?php }else{?><input type="text" name="post_no" datatype='*'><?php }?></span>
								</div>
