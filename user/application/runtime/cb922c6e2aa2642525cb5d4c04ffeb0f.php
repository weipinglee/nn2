...
<div class="user_c">
	<div class="user_zhxi">
       ...
       <div class="opera_suc">
       	<div class="oprsuc_img"><img src="http://localhost/nn2/user/public/views/pc/images/icon/confirm.png" alt="正确"></div>
       	<h3 class="change_red"><?php echo isset($info)?$info:"";?></h3>
         <h5><a href="<?php echo isset($redirect)?$redirect:"";?>">确认&gt;&gt;</a> <a href="javascript:history.back();">取消&gt;&gt;</a></h5>
       </div>
