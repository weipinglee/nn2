...
<script src="http://localhost/nn2/user/public/views/pc/js/pay_ment.js" type="text/javascript"></script>
...
<script type="text/javascript" src="http://localhost/nn2/user/public/views/pc/js/upload.js"></script>
			...
			<div class="user_c_list no_bor">
				<div class="user_zhxi">
                   ...
                   <div id="bain_bo">
                   <form action="http://localhost/nn2/user/public/order/buyerretainage" method="post" enctype="multipart/form-data">
                   <?php if($show_online){?>
                   ...
                   <div class="sty_offline" <?php if(!$show_online){?>style='display: block;'<?php }?>>
                        <ul>
                          ...
                          <input type="hidden" value="<?php if($show_online){?>online<?php }else{?>offline<?php }?>" name="payment"/>
                          <input type="hidden" value="http://localhost/nn2/user/public/ucenter/upload" name="uploadUrl"/>
                  ...
                  <div class="pay_bton">
                  	<h5>待支付金额：<i><?php echo isset($data['pay_retainage'])?$data['pay_retainage']:"";?></i>元</h5>
                  	<a href="javascript:;" id='pay_retainage'><?php if($show_online){?>立即支付尾款<?php }else{?>上传凭证<?php }?></a>
                  </div>
