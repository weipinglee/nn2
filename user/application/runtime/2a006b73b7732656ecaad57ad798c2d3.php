                    ...
                    <div class="list_names">
						...
						<table border="0">
                            ...
                            <tr>
                				...
                				<td colspan="2">
                                    <?php echo isset($storeDetail['store_pos'])?$storeDetail['store_pos']:"";?>
                                </td>
           				 	</tr>
                            <tr>
                                <td nowrap="nowrap"><span></span>仓位：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['cang_pos'])?$storeDetail['cang_pos']:"";?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap"><span></span>入库日期：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['in_time'])?$storeDetail['in_time']:"";?>
                                </td>
                            </tr>
                             <tr>
                                <td nowrap="nowrap"><span></span>租库日期：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['rent_time'])?$storeDetail['rent_time']:"";?>
                                </td>
                            </tr>
                            <tr >
                                <td nowrap="nowrap"><span></span>检测机构：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['check_org'])?$storeDetail['check_org']:"";?>
                                </td>
                            </tr>
                            <tr >
                                <td nowrap="nowrap"><span></span>质检证书编号：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['check_no'])?$storeDetail['check_no']:"";?>
                                </td>
                            </tr>
                               <tr >
                            ...
                            <tr >
                                ...
                                <td colspan="2"> 
                                    <?php echo isset($storeDetail['quantity'])?$storeDetail['quantity']:"";?>(<?php echo isset($storeDetail['unit'])?$storeDetail['unit']:"";?>)
                                </td>
                            </tr>
                                    <?php if( $storeDetail['package'] == 1){?> 
                                            <tr id="packUnit" >
                                                 <td>包装单位：</td>
                                            <td colspan="2">
                                                <?php echo isset($storeDetail['package_unit'])?$storeDetail['package_unit']:"";?>
                                            </td>
                                            </tr>
                                            <tr id='packNumber'>
                                            <td>包装数量：</td>
                                            <td colspan="2">
                                                <?php echo isset($storeDetail['package_num'])?$storeDetail['package_num']:"";?>
                                            </td>
                                            </tr>
                                            <tr id='packWeight' >
                                            <td>包装重量：</td>
                                            <td colspan="2">
                                                <?php echo isset($storeDetail['package_weight'])?$storeDetail['package_weight']:"";?>
                                            </td>
                                            </tr>
                                  <?php }?>
                        ...
                        <table border="0">
                            <tr>
                                ...
                                <td colspan="2">
                                    <?php echo isset($storeDetail['pname'])?$storeDetail['pname']:"";?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap"><span></span>商品属性：</td>
                                <td colspan="2">
                                    <?php echo isset($storeDetail['attrs'])?$storeDetail['attrs']:"";?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap"><span></span>商品分类：</td>
                                <td colspan="2">
                                    <?php foreach($storeDetail['cate'] as $k => $cate){?>
                                        <?php if($k==0){?>
