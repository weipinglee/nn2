...
<script type="text/javascript" src='http://localhost/nn2/user/public/js/upload/upload.js'></script>
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div>
						<form action="http://localhost/nn2/user/public/fund/bank" enctype="multipart/form-data" method='post' auto_submit>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>开户银行：</span>
								<span><input class="text" type="text" datatype="s2-10" nullmsg="填写开户行" name="bank_name" value="<?php echo isset($bank['bank_name'])?$bank['bank_name']:"";?>"></span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span><select class="text" type="text" name="card_type" datatype="n1-2" >
										...
										<option value="<?php echo isset($key)?$key:"";?>" <?php if($key==$bank['bank_type']){?>selected<?php }?>><?php echo isset($item)?$item:"";?></option>
										<?php }?>
										</select>
								</span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span>
									<input class="text" type="text" name="identify" datatype="/^\d{14,17}(\d|x)$/i" value="<?php echo isset($bank['identify_no'])?$bank['identify_no']:"";?>">
								</span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span><input class="text" type="text" name="card_no" datatype="/[0-9a-zA-Z]{15,22}/" value="<?php echo isset($bank['card_no'])?$bank['card_no']:"";?>"></span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span>
									 <input type="hidden" name="uploadUrl"  value="/nn2/user/public/fund/upload" />
