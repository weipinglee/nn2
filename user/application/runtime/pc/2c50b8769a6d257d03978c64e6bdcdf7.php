...
<div class="header">
	...
	<div class="user_body">
		<div class="user_b">
            ...
            <!--end左侧导航-->
            <div id="cont"><script type="text/javascript" src="/nn2/user/js/jquery/jquery-1.8.0.min.js" ></script>
			<!--end左侧导航-->	
			<!--start中间内容-->	
			<div class="user_c public">
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="offer public" onclick="window.open('http://localhost/nn2/user/managerdeal/depositoffer')">
							<div class="offer_left">
								<img src="/nn2/user/views/pc/images/center/publish1.png">
							</div>
							<p class="of_title1">
							...
							<div class="offer public" onclick="if(<?php echo isset($certStatus['status'])?$certStatus['status']:"";?>==4){alert('请完善您的资质认证');window.open('http://localhost/nn2/user/ucenter/dealcert');return false;}window.open('http://localhost/nn2/user/managerdeal/freeoffer')">
							<div class="offer_center">
								<img src="/nn2/user/views/pc/images/center/publish2.png">
							</div>
							<p class="of_title1">
						...
						<div class="offer public" onclick="if(<?php echo isset($certStatus['status'])?$certStatus['status']:"";?>==4){alert('请完善您的资质认证');window.open('http://localhost/nn2/user/ucenter/dealcert');return false;}window.open('http://localhost/nn2/user/managerdeal/storeoffer')">
							<div class="offer_right">
								<img src="/nn2/user/views/pc/images/center/publish3.png">
							</div>
							<p class="of_title1">
						...
						<div class="offer public" onclick="if(<?php echo isset($certStatus['status'])?$certStatus['status']:"";?>==4){alert('请完善您的资质认证');window.open('http://localhost/nn2/user/ucenter/dealcert');return false;}window.open('http://localhost/nn2/user/managerdeal/deputeoffer')">
							<div class="offer_right">
								<img src="/nn2/user/views/pc/images/center/publish4.png">
							</div>
							<p class="of_title1">
