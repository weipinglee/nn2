...
<script type="text/javascript" src="/nn2/user/views/pc/js/product/attr.js" ></script>
            ...
            <div class="user_c">
                <div class="user_zhxi pro_classify">
                    ...
                    <form action="http://localhost/nn2/user/managerdeal/dodepositoffer" method="POST" auto_submit redirect_url="http://localhost/nn2/user/managerdeal/indexoffer">
                        <table border="0" >
...
<input type ="radio" name ="safe" style="width:auto;height:auto;"> 不投保
    ...
    <tr>
            ...
            <textarea name="other"><?php echo isset($offer['other'])?$offer['other']:"";?></textarea>
                        ...
                        <tr>
                            ...
                            <input type="hidden" name='cate_id' id="cate_id" value="<?php echo isset($cate_id)?$cate_id:"";?>">
                                ...
                                <span class="color">买方付首款后需缴纳报盘总金额的<?php echo isset($rate)?$rate:"";?>%的保证金，合同完成后退还</span>
                            </td>
                        </tr>
        ...
        <script type="text/javascript">
            $(function(){
                getCategory(<?php echo isset($cate_id)?$cate_id:"";?>);
            })
        </script>
                    </div>
                </div>
