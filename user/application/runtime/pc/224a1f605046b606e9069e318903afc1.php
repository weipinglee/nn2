                   ...
                   <div class="checkim">
                       ...
                       <form action="http://localhost/nn2/user/deposit/sellerentrustdeposit" auto_submit pay_secret="1" method="post" redirect_url="http://localhost/nn2/user/contract/sellerdetail/id/<?php echo $data['id'];?>">
                           ...
                           <div class="pay_bton">
                               ...
                               <a href="http://localhost/nn2/user/public/deposit/entrustalipay/order_id/<?php echo $data['id'];?>" class="alipay" style='font-size: 16px;width:120px;height: 35px;line-height: 35px;margin: 0;display: none'>立即缴纳委托金</a>
                           </div>
