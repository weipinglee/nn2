...
<div class="header">
 ...
 <script type="text/javascript" src="/nn2/user/js/form/formacc.js" ></script>
  <script type="text/javascript" src="/nn2/user/js/form/validform.js" ></script>
			<div class="user_c">
				<div class="user_zhxi">
				<form method="post" action="http://localhost/nn2/user/ucenter/chgpass" auto_submit >
					<div class="zhxi_tit">
					...
					<div style="float:left">
						...
						<div class="zhxi_con">
							...
							<span></span>
							<span><a style="color:#0088cc;" href="http://localhost/nn2/user/login/passwordreset">忘记密码？</a></span>
						</div>
						<div class="zhxi_con">
