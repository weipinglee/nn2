						...
						<div class="xx_center">
							<table border="0"  cellpadding="" cellspacing="">
								...
								<tr>
									...
									<td><span class="col000000"><?php echo isset($list['status_text'])?$list['status_text']:"";?></span></td>
									<td><a href="http://localhost/nn2/user/ucenter/subaccpow/id/<?php echo $list['id'];?>">分配权限</a>
									<a href="http://localhost/nn2/user/fund/subaccindex/id/<?php echo $list['id'];?>">转账</a>
									</td>
								</tr>
								<?php }?>
