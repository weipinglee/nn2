					...
					<div class="chp_xx">
						...
						<p>出库信息</p>
							...
							<div class="sj_detal">
								...
								<span>&nbsp;<?php echo isset($info['status_txt'])?$info['status_txt']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">审核意见：</b>
								<span>&nbsp;<?php echo isset($info['admin_msg'])?$info['admin_msg']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit"></b>
								<span>&nbsp;<a href="http://localhost/nn2/user/managerstore/storedeliverycheck/id/<?php echo $info[id];?>" style="background: #FC7300;padding: 8px 15px;color:#fff;text-decoration: none">确认出库</a></span>
							</div>
							...
							<div class="sj_detal">
								...
								<span>&nbsp;<?php echo isset($info['name'])?$info['name']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">产品大类：</b>
								<span>&nbsp;<?php echo isset($info['cate_name'])?$info['cate_name']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">规格：</b>
								<span>&nbsp;<?php echo isset($info['attrs'])?$info['attrs']:"";?></span>
							</div>

							<div class="sj_detal">
								<b class="sj_de_tit">产地：</b>
								<span id="area">&nbsp;                     <span id="areatextareat">
                        <script type="text/javascript">
                         ( function(){
							...
							<div class="sj_detal">
								...
								<span>&nbsp;￥<?php echo isset($info['price'])?$info['price']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">数量：</b>
								<span>&nbsp;<?php echo isset($info['quantit'])?$info['quantit']:"";?><?php echo isset($info['unit'])?$info['unit']:"";?></span>
							</div>
							<div class="sj_detal">
								<b class="sj_de_tit">交收地点：</b>
								<span>&nbsp;<?php echo isset($info['accept_area'])?$info['accept_area']:"";?></span>
							</div>
							<p>提货人信息</p>
							<div class="sj_detal">
