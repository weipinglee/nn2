...
<script type="text/javascript" src='/nn2/user/js/upload/upload.js'></script>
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div id="bank1" <?php if( isset($bank['status'])){?>style="display: none"<?php }?>>

						<form action="http://localhost/nn2/user/fund/outcard" enctype="multipart/form-data" method='post' auto_submit>
							...
							<div class="zhxi_con">
								...
								<span><input class="text" type="text" name="no" datatype="/^[0-9a-zA-Z]{8,20}$/i" value="<?php echo isset($bank['no'])?$bank['no']:"";?>" ></span>
								<span></span>
							...
							<div class="zhxi_con">
								...
								<span><input class="text" type="text" datatype="s2-20" name="name" value="<?php echo isset($bank['name'])?$bank['name']:"";?>"></span>
								<span></span>
							</div>
					...
					<div id="bank2" <?php if( !isset($bank['status'])){?> style="display: none" <?php }?>>
							...
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>银行账号：</span>
								<span class="con_con"><?php echo isset($bank['no'])?$bank['no']:"";?></span>

							</div>
							<div class="zhxi_con">
								<span class="con_tit"><i>*</i>姓名：</span>
								<span class="con_con"><?php echo isset($bank['name'])?$bank['name']:"";?></span>
								<span></span>
							</div>
					</div>
