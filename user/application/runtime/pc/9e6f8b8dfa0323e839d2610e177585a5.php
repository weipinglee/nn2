...
<head>
  ...
  <script src="/nn2/user/views/pc/js/topnav20141027.js" type="text/javascript"></script>
   ...
   <!--  收藏样式 -->
 <link href="/nn2/user/views/pc/css/favoritelist.css" rel="stylesheet" type="text/css" /> 
<!-- 支付样式 -->
...
<script type="text/javascript" src="/nn2/user/views/pc/js/upload.js"></script>
			...
			<div class="user_c">
				...
				<form method="post" auto_submit action="http://localhost/nn2/user/ucenter/dosubacc" redirect_url="http://localhost/nn2/user/ucenter/subacclist">
					<div style="float:left">

						<input type="hidden" name="id" value="<?php echo isset($user['id'])?$user['id']:"";?>"/>
						<div class="zhxi_con">
							<span class="con_tit"><i>*</i>用户名：</span>
							<span><input class="text" type="text" name="username" datatype="/^[a-zA-Z0-9_]{3,30}$/" errormsg="请填写3-30位字母数字下划线的组合" value="<?php echo isset($user['username'])?$user['username']:"";?>" /></span>
						<span></span>
						</div>

						<div class="zhxi_con">
							<span class="con_tit"><i>*</i>手机号：</span>
							<span><input class="text" type="text" name="mobile" datatype="mobile" value="<?php echo isset($user['mobile'])?$user['mobile']:"";?>" /></span>
							<span></span>
						</div>

						<div class="zhxi_con">
							<span class="con_tit"><i>*</i>邮箱：</span>
							<span><input class="text" type="text" name="email"  datatype="e" value="<?php echo isset($user['email'])?$user['email']:"";?>" /></span>
							<span></span>
						</div>
						...
						<!-- <div class="zhxi_con">
							...
							<span>
									<input type="radio" name="status" <?php if($user['status']==1){?>checked<?php }?> value="1"/>关闭
									<input type="radio" name="status" <?php if($user['status']==0){?>checked<?php }?> value="0"/>开启
							</span>
						</div> -->
					...
					<div class="zhxi_upimg">
						<div id="dd" class="up_img"><img name="file1" src="<?php if(isset($user['head_photo_thumb'])){?><?php echo isset($user['head_photo_thumb'])?$user['head_photo_thumb']:"";?><?php }else{?>/nn2/user/views/pc/images/icon/wt.jpg<?php }?>"/></div>
						<div>
