		...
		<div class="user_b">
			...
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div>
						<form action="http://localhost/nn2/user/public/ucenter/checkmobilecode" method="post" auto_submit redirect_url="http://localhost/nn2/user/public/ucenter/mobilenew">
       
                        <div class="jd_img"><img src="http://localhost/nn2/user/public/views/pc/images/center/yz_jd1.jpg"></div>
						<div class="zhxi_con">
							<span class="con_tit"><i></i>手机号码：</span>
							<span><?php echo isset($userInfo['mobile'])?$userInfo['mobile']:"";?></span>
						</div>
						<div class="zhxi_con">
                            <span class="con_tit"><i></i>验证码：</span>
                              <div>
                                ...
                                <img id='image' width="" height="45" src="http://localhost/nn2/user/public/index/getcaptcha" onclick="this.src='http://localhost/nn2/user/public/index/getcaptcha?'+Math.random()" />
...
<script type="text/javascript">
    function getMobileCode(){
        ...
        $.ajax(
                {
                    type:'post',
                    url:"http://localhost/nn2/user/public/ucenter/getoldmobilecode",
                    cache:false,
                    dataType:'json',
   ...
   function checkMobileCode(){
        ...
        $.ajax({
            type:'post',
            url:"http://localhost/nn2/user/public/ucenter/checkmobilecode",
            dataType:'json',
