				...
				<div class="user_zhxi">
					...
					<div style="float:left">
						...
						<div class="zhxi_con">
							...
							<span><input class="text" type="text" disabled="disabled" value="<?php echo isset($user['username'])?$user['username']:"";?>" name="username"/>
						</div>
						<div class="zhxi_con">
							<span class="con_tit"><i></i>手机号码：</span>
							<span><input class="text" disabled="disabled" value="<?php echo isset($user['mobile'])?$user['mobile']:"";?>" type="text" name="mobile"/>
						...
						<div class="zhxi_con">
							...
							<span><input class="text" type="text" disabled="disabled" value="<?php echo isset($user['email'])?$user['email']:"";?>" name="email"/>
						</div>


						<div class="zhxi_con">
							<span><a href="http://localhost/nn2/user/public/ucenter/baseedit"><input class="submit_edit" type="button" value="修改"/></a></span>
						</div>
