			...
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div style="float:left">
						<form method="post" action="http://localhost/nn2/user/public/ucenter/dobase" auto_submit redirect_url="http://localhost/nn2/user/public/ucenter/baseinfo">
						<div class="zhxi_con">
							<span class="con_tit"><i>*</i>用户名：</span>
							<span><input class="text" type="text"  value="<?php echo isset($user['username'])?$user['username']:"";?>" datatype="/^[a-zA-Z0-9_]{3,30}$/" nullmsg="请填写用户名" errormsg="请使用3-30位字母数字下划线的组合" name="username"/></span>
							<span></span>
						</div>
						<div class="zhxi_con">
							<span class="con_tit"><i></i>手机号码：</span>
							<span><input class="text" disabled="disabled" value="<?php echo isset($user['mobile'])?$user['mobile']:"";?>" type="text" name="mobile_no"/>
							<a href="http://localhost/nn2/user/public/ucenter/mobileedit"><i class="icon-info-sign"></i>点击修改手机号码</a>
