        ...
        <div class="main">
            ...
            <div align="center">
                ...
                style="border:1px #000 solid; border-collapse:collapse; margin:10px 0px;">
                    <tr style="height:35px">
                        ...
                        <td style="padding:0 10px; " width="110px"><?php echo isset($info['seller_name'])?$info['seller_name']:"";?></td>
                        <td style="padding:0 10px; " width="110px">合同编号</td>
                        <td style="padding:0 10px; " width="110px"><?php echo isset($info['order_no'])?$info['order_no']:"";?></td>
                    </tr>
                    <tr style="height:35px">
                        <td style="padding:0 10px;" width="110px">买方（乙方）</td>
                        <td style="padding:0 10px;" width="110px"><?php echo isset($info['buyer_name'])?$info['buyer_name']:"";?></td>
                        <td style="padding:0 10px; " width="110px">签约时间</td>
                        <td style="padding:0 10px;" width="110px"><?php echo isset($info['create_time'])?$info['create_time']:"";?></td>
                    </tr>
                </table>
            </div>
            ...
            <div>
                <table border="1" bordercolor="#000000" cellspacing="0" cellpadding="0" width="100%"
                    ...
                    <tr style="height:35px">
                        ...
                        <td style="padding:0 10px"><?php echo isset($info['name'])?$info['name']:"";?></td>
                    </tr>
                    <tr style="height:35px">
                        <td width="100px" style="padding:0 10px">商品规格:</td>
                        <td style="padding:0 10px"><?php echo isset($info['attrs'])?$info['attrs']:"";?></td>
                    </tr>
                    <tr style="height:35px">
                        <td width="100px" style="padding:0 10px">生产地:</td>
                        <td style="padding:0 10px" id='areatextarea'>                    <span id="areatextarea">
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">二、数量
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第二条 买卖双方通过交易平台电子交易平台成交的数量：___________<?php echo isset($info['num'])?$info['num']:"";?><?php echo isset($info['unit'])?$info['unit']:"";?>_______________。（以挂牌交易中双方达成的交易数量为准） <!-- 计重：________________ -->。（以挂牌交易中双方达成的约定为准）</li>
                    <li style="text-indent: 20px;">第三条 产品质量补充说明 　　（以挂牌交易中的相关商品描述为准，或双方自行约定）
        _______________<?php echo isset($info['other'])?$info['other']:"";?>_______________</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">三、成交价格与成交时间
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第四条 买卖双方通过交易平台电子交易系统成交的产品的含税单价为_______<?php echo isset($info['price'])?$info['price']:"";?>_______元（人民币）/__<?php echo isset($info['unit'])?$info['unit']:"";?>__(单位)。（以挂牌交易中买卖双方达成的交易价格为准）</li>
                    <li style="text-indent: 20px;">第五条 成交时间:________<?php echo isset($info['create_time'])?$info['create_time']:"";?>________（以挂牌交易中双方达成的交易时间为准）</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">四、交收地点
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第六条 本合同项下货物的交收地点在交易所指定的交收地，该商品交收地为_______<?php echo isset($info['accept_area'])?$info['accept_area']:"";?>_________。（以挂牌交易中约定的交收地点，或买卖双方自行约定的交收地点为准）</li>
                </ol>
            </div>
