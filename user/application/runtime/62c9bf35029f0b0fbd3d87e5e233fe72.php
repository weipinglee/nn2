...
<script type="text/javascript" src="http://localhost/nn2/user/public/js/upload/ajaxfileupload.js"></script>
<script type="text/javascript" src="http://localhost/nn2/user/public/js/upload/upload.js"></script>
<script type="text/javascript" src="http://localhost/nn2/user/public/views/pc/js/cert/cert.js"></script>
<input type="hidden" name="uploadUrl"  value="http://localhost/nn2/user/public/ucenter/upload" />
			<div class="user_c">
				<div class="user_zhxi">
					...
					<form method="post" action="http://localhost/nn2/user/public/ucenter/dodealcert" auto_submit>
					<div class="re_xx">
                ...
                <span></span>
					...
					<div class="yz_img">
						...
						<div class="zhxi_con">
							...
							<span class="zh_img">
								<img name="file1" src="<?php if(isset($certData['cert_bl_thumb'])){?><?php echo isset($certData['cert_bl_thumb'])?$certData['cert_bl_thumb']:"";?><?php }else{?>http://localhost/nn2/user/public/views/pc/images/icon/wt.jpg<?php }?>"/>
							</span>
						</div>
						<div class="zhxi_con">
						...
						<div class="zhxi_con">
							<span class="con_tit tit_img"><i></i></span>
							<span class="zh_img">
								<img name="file2" src="<?php if(isset($certData['cert_tax_thumb'])){?><?php echo isset($certData['cert_tax_thumb'])?$certData['cert_tax_thumb']:"";?><?php }else{?>http://localhost/nn2/user/public/views/pc/images/icon/wt.jpg<?php }?>"/>
							</span>
						</div>
						<div class="zhxi_con">
						...
						<div class="zhxi_con">
							<span class="con_tit tit_img"><i></i></span>
							<span class="zh_img">
								<img name="file3" src="<?php if(isset($certData['cert_oc_thumb'])){?><?php echo isset($certData['cert_oc_thumb'])?$certData['cert_oc_thumb']:"";?><?php }else{?>http://localhost/nn2/user/public/views/pc/images/icon/wt.jpg<?php }?>"/>
							</span>
						</div>
						<div class="zhxi_con">
						...
						<?php }else{?>
							...
							<div class="zhxi_con">
								<span class="con_tit tit_img"><i></i></span>
								<span class="zh_img">
									<img name="file1" src="<?php if(isset($certData['identify_front_thumb'])){?><?php echo isset($certData['identify_front_thumb'])?$certData['identify_front_thumb']:"";?><?php }else{?>http://localhost/nn2/user/public/views/pc/images/icon/wt.jpg<?php }?>"/>
								</span>
							</div>
							...
							<div class="zhxi_con">
								<span class="con_tit tit_img"><i></i></span>
								<span class="zh_img">
									<img name="file2" src="<?php if(isset($certData['identify_back_thumb'])){?><?php echo isset($certData['identify_back_thumb'])?$certData['identify_back_thumb']:"";?><?php }else{?>http://localhost/nn2/user/public/views/pc/images/icon/wt.jpg<?php }?>"/>
								</span>
							</div>
					...
					<div class="sh_jg">
						<div class="success_text">
							...
							<p><?php echo isset($certData['message'])?$certData['message']:"";?></p>
