        ...
        <div class="topnav_left">
            <div class="login_link" id="toploginbox">
                ...
                <?php }else{?>
                    ...
                    <a  href="http://deal.test.com/index/index">首页</a>
                <?php }?>
            </div>
...
<div class="header">
	...
	<div class="user_body">
		<div class="user_b">
            ...
            <!--end左侧导航-->
            <div id="cont">
                <script type="text/javascript" src="/nn2/user/public/js/jquery/jquery-1.8.0.min.js" ></script>
			<!--end左侧导航-->	
			<!--start中间内容-->	
			<div class="user_c public">
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="offer public" onclick="window.open('http://localhost/nn2/user/public/managerdeal/depositoffer')">
							<div class="offer_left">
								<img src="/nn2/user/public/views/pc/images/center/publish1.png">
							</div>
							<p class="of_title1">
						...
						<div class="offer public" onclick="window.open('http://localhost/nn2/user/public/managerdeal/freeoffer')">
							<div class="offer_center">
								<img src="/nn2/user/public/views/pc/images/center/publish2.png">
							</div>
							<p class="of_title1">
						...
						<div class="offer public" onclick="window.open('http://localhost/nn2/user/public/managerdeal/storeoffer')">
							<div class="offer_right">
								<img src="/nn2/user/public/views/pc/images/center/publish3.png">
							</div>
							<p class="of_title1">
						...
						<div class="offer public" onclick="window.open('http://localhost/nn2/user/public/managerdeal/deputeoffer')">
							<div class="offer_right">
								<img src="/nn2/user/public/views/pc/images/center/publish4.png">
							</div>
							<p class="of_title1">
