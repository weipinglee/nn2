					...
					<div class="chp_xx">
						<div class="offer">
							<div class="offer_left">
								<img src="http://localhost/nn2/user/public/views/pc/images/center/offter1.jpg">
							</div>
							<p class="of_title1">
								<a class="title1_a" href="http://localhost/nn2/user/public/index.php//managerdeal/productadd/mode/2">保证金报盘</a>
							</p>
						...
						<div class="offer">
							<div class="offer_center">
								<img src="http://localhost/nn2/user/public/views/pc/images/center/offter2.jpg">
							</div>
							<p class="of_title1">
								<a class="title1_a" href="http://localhost/nn2/user/public/index.php//managerdeal/productadd/mode/1">自由报盘</a>
							</p>
						...
						<div class="offer">
							<div class="offer_right">
								<img src="http://localhost/nn2/user/public/views/pc/images/center/offter3.jpg">
							</div>
							<p class="of_title1">
								<a class="title1_a" href="http://localhost/nn2/user/public/index.php//managerdeal/store/mode/3">仓单报盘</a>
							</p>
