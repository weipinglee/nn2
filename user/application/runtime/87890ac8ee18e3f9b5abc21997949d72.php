			...
			<div class="user_c">
				<div class="user_zhxi">
                    ...
                    <div class="list_names">
                        <span>仓库名称:</span>
                        <span><?php echo isset($storeDetail['sname'])?$storeDetail['sname']:"";?></span>
                    </div>
                     
                    <form action="http://localhost/nn2/user/public/managerstore/dostoresign" method="POST" auto_submit redirect_url="http://localhost/nn2/user/public/managerstore/applystorelist/type/2">
						<table border="0">
                            <tr>
                                <td nowrap="nowrap"><span></span>状态：</td>
                                <td colspan="2">
                                   <?php echo isset($storeDetail['status_txt'])?$storeDetail['status_txt']:"";?>
                                </td>
                            </tr>
                            <tr>
              					<td nowrap="nowrap"><span></span>库位：</td>
                				<td colspan="2"> 
                                    <input class="text" type="text" name="pos" datatype="s1-20" errormsg="库位请填写1-20位字符" <?php if( !empty($storeDetail['store_pos'])){?> value="<?php echo isset($storeDetail['store_pos'])?$storeDetail['store_pos']:"";?>" readonly="readonly" <?php }?>>
                                </td>
           				 	</tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2"> 
                                    <input name="inTime" value="<?php echo isset($storeDetail['in_time'])?$storeDetail['in_time']:"";?>" datatype="date" errormsg="请选择日期" class="Wdate addw" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" type="text">
                                </td>
                            </tr>
                             <tr>
                                <td nowrap="nowrap"><span></span>租库日期：</td>
                                <td colspan="2"> 
                                    <input name="rentTime" value="<?php echo isset($storeDetail['rent_time'])?$storeDetail['rent_time']:"";?>" datatype="date" errormsg="请选择日期" class="Wdate addw" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" type="text">
                                </td>
                            </tr>
                            <tr >
                            ...
                            <tr >
                               ...
                               <tr >
                                ...
                                <td colspan="2"> 
                                    <?php if( $storeDetail['package'] == 1){?> 是 <?php }else{?> 否<?php }?>
                                </td>
                            </tr>
                            <tr >
                                <td nowrap="nowrap"><span></span>总重量：</td>
                                <td colspan="2"> 
                                    <input class="text" type="text" name="quantity" datatype="float" errormsg="请填写小数或整数" value="<?php echo isset($storeDetail['quantity'])?$storeDetail['quantity']:"";?>">(<?php echo isset($storeDetail['unit'])?$storeDetail['unit']:"";?>)
                                </td>
                            </tr>
                                    <?php if( $storeDetail['package'] == 1){?> 
                                            <tr id="packUnit" >
                                                 <td>包装单位：</td>
                                            <td colspan="2">
                                                <input type="text" class='text' name="packUnit" value="<?php echo isset($storeDetail['package_unit'])?$storeDetail['package_unit']:"";?>" readonly="readonly">
                                            </td>
                                            </tr>
                                            <tr id='packNumber'>
                                            <td>包装数量：</td>
                                            <td colspan="2">
                                                <input type="text" class='text' name="packNumber" value="<?php echo isset($storeDetail['package_num'])?$storeDetail['package_num']:"";?>">
                                            </td>
                                            </tr>
                                            <tr id='packWeight' >
                                            <td>包装重量：</td>
                                            <td colspan="2">
                                                <input type="text" class='text' name="packWeight" value="<?php echo isset($storeDetail['package_weight'])?$storeDetail['package_weight']:"";?>">
                                            </td>
                                            </tr>
                                  <?php }?>
    				...
    				<span class="zhs_img">
                        ...
                        <tr>
                            ...
                            <input type="hidden" value="<?php echo isset($storeDetail['sid'])?$storeDetail['sid']:"";?>" name="id" >
