            ...
            <div class="user_c_list no_bor">
                <div class="user_zhxi">
                   ...
                   <div class="checkim">
                       ...
                       <form action="http://localhost/nn2/user/deposit/sellerdeposit" auto_submit pay_secret="1" method="post" redirect_url="http://localhost/nn2/user/contract/sellerdetail/id/<?php echo $data['id'];?>">
