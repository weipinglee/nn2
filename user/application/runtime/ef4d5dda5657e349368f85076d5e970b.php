  ...
  <link href="http://localhost/nn2/user/public/views/pc/css/pay_ment.css" rel="stylesheet" type="text/css" /> 
			...
			<div class="user_c_list no_bor">
				<div class="user_zhxi">
					...
					<div class="deal_succeed">
                                      <div class="scsd_img">
                                          <img src="http://localhost/nn2/user/public/views/pc/images/order/oder_01.jpg" alt="对勾">
                                          <h3>支付成功</h3>
                                        </div> 
                                     
                                      <div class="scsd_word add">
                                          <h5><?php echo isset($title)?$title:"";?></h5>
                                          <p><?php echo isset($info)?$info:"";?></p>
