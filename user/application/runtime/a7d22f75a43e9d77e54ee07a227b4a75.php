							...
							<table class="hy_info" width="100%">
								<tr>
									<td colspan="2" width="450px">
										<ul class="dj">
											<li>会员等级：<span class="colaa0707"><?php echo isset($group['group_name'])?$group['group_name']:"";?></span></li>
											<li><!--<img src="<?php echo isset($group['icon'])?$group['icon']:"";?>"/>--></li>
											<li>
											...
											<li>
												<!--<img src="/nn2/user/views/pc/images/center/icon_yin.jpg"/>-->
											&nbsp;<span>距离升级还需 <?php echo isset($creditGap)?$creditGap:"";?> 信誉分</span>
											</li>
										</ul>
									</td>
									<td rowspan="2" width="280px">
										<div class="icon_rz">
											<?php if(!empty($cert)) foreach($cert as $key => $item){?>
												<?php if($cert[$key]==1){?>
											<span><img src="/nn2/user/views/pc/images/center/icon_yrz.jpg"><?php echo \nainai\cert\certificate::$certRoleText[$key];?>已认证</span>
												<?php }?>
											<?php }?>
											<?php if($href){?>
												<a href="<?php echo isset($href)?$href:"";?>">去认证</a>
											<?php }?>
										</div>
									</td>
								</tr>
