			...
			<div class="user_c">
				...
				<form action="" method="get">
					...
					<div>
						<div class="zj_gl">
							<div class="zj_l">
								<a href="http://localhost/nn2/user/fund/zxpage" class="zj_a cz"><?php if(isset($no)){?>账户信息<?php }else{?>开通<?php }?></a>
								<?php if(isset($no)){?>
								<a href="http://localhost/nn2/user/fund/zxtx" class="zj_a tx">提现</a>
								<p class="re_t">结算账号资金总额</p>
								<h1 class="rental">￥<?php echo $balance['SJAMT'];?></h1>
								<?php }?>
								<p class="state"></p>
							</div>
							<div class="zj_r">
								...
								<div class="zj_column">
									<span class="column_yes" style="width:<?php echo $balance['DJAMT']/($balance['SJAMT'])*300;?>px;" title="<?php echo isset($balance['DJAMT'])?$balance['DJAMT']:"";?>"></span>
									<span class="column_no" style="width:<?php echo $balance['KYAMT']/($balance['SJAMT'])*300;?>px;" title="<?php echo isset($balance['KYAMT'])?$balance['KYAMT']:"";?>"></span>
									<div class="clear"></div>
								</div>
								<div class="price">
									<span class="price_l">
                    ...
                    <div class="zj_mx">
                        ...
                        <div class="mx_r">
							 交易时间：<input class="Wdate" name="startDate" type="text" value="<?php echo isset($startDate)?$startDate:"";?>" onClick="WdatePicker()">
							<span class="js_span1">-</span>
							<input class="Wdate" type="text" name="endDate" value="<?php echo isset($endDate)?$endDate:"";?>" onClick="WdatePicker()">
                    ...
                    <table cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<!-- <td><?php echo isset($item['HOSTFLW'])?$item['HOSTFLW']:"";?></td>
							<td><?php echo isset($item['TRANDATE'])?$item['TRANDATE']:"";?><?php echo isset($item['TRANTIME'])?$item['TRANTIME']:"";?></td>
							<td><?php echo isset($item['TRANTYPE_TEXT'])?$item['TRANTYPE_TEXT']:"";?></td>
							<td><?php echo isset($item['TRANAMT'])?$item['TRANAMT']:"";?></td>
							<td><?php echo isset($item['ACCBAL'])?$item['ACCBAL']:"";?></td>
							<td><?php echo isset($item['OPPACCNO'])?$item['OPPACCNO']:"";?></td>
							<td><?php echo isset($item['OPPACCNAME'])?$item['OPPACCNAME']:"";?></td> -->
							<td><?php echo isset($item['tellerNo'])?$item['tellerNo']:"";?></td>
							<td><?php echo isset($item['tranDate'])?$item['tranDate']:"";?><?php echo isset($item['tranTime'])?$item['tranTime']:"";?></td>
							<td><?php echo isset($item['TRANTYPE_TEXT'])?$item['TRANTYPE_TEXT']:"";?></td>
							<td><?php echo isset($item['tranAmt'])?$item['tranAmt']:"";?></td>
							<td><?php echo isset($item['accBalAmt'])?$item['accBalAmt']:"";?></td>
							<td><?php echo isset($item['accountNo'])?$item['accountNo']:"";?></td>
							<!-- <td><?php echo isset($item['accountNm'])?$item['accountNm']:"";?></td> -->
							<td><?php echo isset($item['verifyCode'])?$item['verifyCode']:"";?></td>
							<td><?php echo isset($item['subno'])?$item['subno']:"";?></td>
