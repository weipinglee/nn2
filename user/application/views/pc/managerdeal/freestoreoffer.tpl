...
<script type="text/javascript" src="{root:js/upload/upload.js}"></script>
            ...
            <div class="user_c">
                <div class="user_zhxi">
                    <div class="zhxi_tit">
                        <p><a>产品管理</a>><a>入库单报盘</a></p>
                    </div>
                    <div class="center_tabl">

                    <input type="hidden" id='ajaxGetStoreUrl' value="{url:/Managerdeal/ajaxGetStore}">
                    <form action="{url:/Managerdeal/doFreestoreOffer}" method="POST" auto_submit redirect_url="{url:/managerdeal/indexoffer}">
                        <table border="0">
                            <tr>
                                ...
                                <td>
                                    <span>
                                       ...
                                       <div class="zhxi_con">
                                           ...
                                           <div  >
                                               <img name="file1" src=""/>
                                               <input type="hidden"  name="imgfile1" value="" datatype="*" nullmsg="请上传委托书图片" alt="请上传图片" />
                                           </div>
