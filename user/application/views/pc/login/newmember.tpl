    ...
    <div class="member_a clear">
      <div class="member_nav">
        <ul class="member_nav_ul">
          ...
          <li><a>耐购联盟会员</a></li>
          <li class="member_nav_ul2"><a class="curs mtjian">免费体验</a></li>
        ...
        <div class="member_c_i">
          <div class="reg_cot qy_reg member_c_sq" style="display: none;">
            ...
            <form action="{if:$oper=='update'}{url:/login/updateMember@user}{else:}{url:/login/newMember@user}{/if}" method="post" auto_submit redirect_url="">
                <input type="hidden" name="vip_type" value="1" />
             {if:!$login}
              <div class="cot">
          ...
          <div class="member_c_tq2" style="display: none">
            ...
            <p>10、竞价优先权：
            <p style="text-indent: 20px;">(1)优先竞价权：竞价活动启动前平台即通知竞价活动信息，联盟商收到通知时即可进入排队竞价队列，第一个回复在竞价启动时即自动完成起拍价竞价（不限于铝矾土生料、熟料，联盟商可提供所需产品清单）。</p>
           <p style="text-indent: 20px;">(2)竞价免保证金权益：根据竞价规则，参与竞价方需按出价金额缴纳保证金，联盟商参与竞价时无需缴纳保证金，若竞价成功，在竞价完成后2小时内缴纳货款即可。</p></p>
