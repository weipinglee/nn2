				...
				<div class="user_zhxi">
					...
					<div class="chp_xx">
						<div class="de_ce">
							...
							<form action="{url:/storeDelivery/storeOut}" method="post" auto_submit  redirect_url="{url:/delivery/deliselllist}">
								<input type="hidden" name="id" value="{$info['id']}" />
								<a href="javascript:void(0)" confirm="1" confirm_text="确定要出库吗？" style="background: #FC7300;padding: 8px 15px;color:#fff;text-decoration: none">确认出库</a>
							</form>
							</div>
						</div>
						<div class="sjxx">
