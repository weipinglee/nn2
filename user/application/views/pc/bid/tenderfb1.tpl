			...
			<div class="user_c">
				<div class="user_zhxi">
					...
					<div class="center_tabl">
                                                            ...
                                                            <div class="clear"></div>
                                                            <form method="post" action="{url:/bid/tenderfb2}?type=" enctype="multipart/form-data">
                                                                <div class="invite" style="margin-top:30px;">

                                                                    <div class="invite_cont">
                                                                        <span style="float:left;line-height:25px;">标书：</span>
                                                                        <input type="file" accept="" name="doc">
                                                                        <p>只允许上传DOC类型的文件！</p>
                                                                    </div>
                                                                </div>
