					...
					<div class="center_tabl">
                                                            ...
                                                            <div class="bid" style="margin-top:30px;">
                                                                <div class="bid_cont" >
                                                                    ...
                                                                    <textarea style="resize: none;width:100%;"></textarea>
                                                                    <p>
                                                                        <input type="radio" checked name="include">分包&nbsp;&nbsp;说明：投标人可以单个包件投标
                                                                        
                                                                        <input type="radio" name="include" style="margin-left:30px;">总包&nbsp;&nbsp;说明：选择此按钮投标人需要投所有的包件
                                                                    ...
                                                                    <p>3、我公司招标办于<input type="date" value="">起以每份
                                                                        <input type="date" value="">元人民币的价格出售标书，售后不退。</p>
                                                                    

                                                                    <h3>五、投标文件的递交与开标时间及地点</h3>
                                                                    <p>1、合格投标人应在投标截止日前通过耐耐网电子商务平台进行网上投标，在上传投标文件的同时，提交保证金<input type="text">元，未中标者在投标结果发布之后退还，中标者在签订合同并缴纳合同履约金后予以退还。</p>
                                                                    <p>2、开标方式：<select name="" id=""><option value="">线上</option></option></select></p>
                                                                    <h3>六、支付方式</h3>
