           ...
           case 'user_bank':
            ...
            case 'recharge_orderline':
              ...
              case 'product_offer':
                ...
                'market'=>'商品大类','cate'=>'商品种类','name' => '商品名','attr'=>'商品属性', 'type_txt' => '交易方式', 'mode_txt' => '类型','sub_mode'=>'子报盘类型','offer_fee'=>'报盘费率', 'divide_text' => '可否拆分',
                    'quantity' => '数量', 'sell_num'=>'已售数量','unit'=>'计量单位', 'price' => '挂牌价', 'note'=>'产品描述','other'=>'补充条款','apply_time'=>'申请时间','expire_time'=>'过期时间', 'status_txt' => '状态'
                );
                break;
              case 'user_log':
                ...
                break;
              case 'order_sell':
                $config = array('order_no' => '订单编号', 'create_time' => '合同开始日期', 'end_time' => '合同完成日期', 'product_name' => '商品名称','offer_id'=>'报盘id', 'buyer_name' => '买方名称', 'seller_name' => '卖方名称', 'mode_txt' => '交易方式', 'type_txt' => '报盘方式', 'sub_mode'=>'子报盘方式','num' => '成交数量', 'amount' => '合同金额', 'reduce_amount' => '质量扣款金额', 'account' => '结算金额', 'title' => '合同状态');
                break;
                case 'payto_market':
