...
class store{
    ...
    private $storeProduct = 'store_products';//²Öµ¥ÊýŸÝ±í


    private $storeProductRules = array(
        array('store_id','number','请选择仓库!'),
    );
    ...
    public function createStoreProduct($productData,$storeData){
        ...
        if($res===true){
            ...
            $resInfo = Tool::getSuccInfo(0,is_string($res) ? $res : 'ÏµÍ³·±ÃŠ£¬ÇëÉÔºóÔÙÊÔ');
        }
        return $resInfo;
