...
<form method="post" <?php if($data['show_payment']){?>pay_secret="1" has_secret="http://localhost/nn2/index.php/trade/hasPaySecret/"<?php }?> auto_submit="1" action='http://localhost/nn2/index.php/trade/buyerPay/?callback=/offers/check/id/<?php echo $data['id'];?>/pid/<?php echo $data['product_id'];?>'>
