    ...
    <div class="topnav_width">
        <div class="topnav_left">
            <div class="top_index">
                ...
                <a rel="external nofollow" href="http://124.166.246.120:8000/user/public/index.php/index/index" target="_blank" >耐耐网首页</a>
            </div>

            <div class="index_user">
            <?php if($username){?>您好，
                <a rel="external nofollow"  href="http://localhost/nn2/user//index.php/ucenterindex/index"  target="_blank" class=""><?php echo isset($username)?$username:"";?></a>
                <?php }else{?>
            ...
            <div class="login_link" id="toploginbox">
                <a rel="external nofollow" href="http://localhost/nn2/user//index.php/login/login" target="_blank" class="topnav_login">请登录</a>
            </div>
            <div class="topnav_regsiter">
                <a rel="external nofollow" href="http://localhost/nn2/user//index.php/login/register" target="_blank">免费注册</a>
            </div>
            <?php }else{?>
            <div class="login_link" id="toploginbox">
                <a rel="external nofollow" href="http://localhost/nn2/user//index.php/login/logout" target="_blank" class="topnav_login">退出</a>
            </div>
            <?php }?>
        </div>
        <div class="topnav_right">
            <ul>
                <?php if($login!=0){?>
                 <li>
                   <a href="http://localhost/nn2/user//index.php/ucenterindex/index">会员中心</a><span class="line_l">|<span>
                </li>
                <li>
                   <a href="http://localhost/nn2/user//index.php/contract/buyerlist">我的合同</a><span class="line_l">|<span>
                </li>
                <?php }?>
                <li>
                    <a href="http://localhost/nn2/user//index.php/message/usermail">消息中心<?php if($login==1&&$mess!=0){?><em class="information"><?php echo isset($mess)?$mess:"";?></em><?php }?></a><span class="line_l">|<span>
                </li>
                <!--<li>
...
<div id="index_logo">
    <div class="page_width">
        <div class="index_logo">
            <h1>
                <a href="http://localhost/nn2/index.php/index/index"></a>
            </h1>
        </div>
        ...
        <script type="text/javascript">
            function searchGoods(){
                ...
                window.location.href='http://localhost/nn2/index.php/offers/offerlist/type/'+type+'/content/'+content;
            }
...
<div id="index_nav">
    <div class="page_width">
        ...
        <ul class="nav">
            <li <?php if(!isset($cur) || $cur=='index'){?>class="current"<?php }?>><a href="http://localhost/nn2/index.php/index/index">首页</a></li>
            <li <?php if(isset($cur) && $cur=='offerlist'){?>class="current"<?php }?>><a href="http://localhost/nn2/index.php/offers/offerlist" target="_blank">交易中心</a></li>
            <li <?php if(isset($cur) && $cur=='storage'){?>class="current"<?php }?>><a href="http://localhost/nn2/index.php/index/storage" target="_blank">仓储专区</a></li>
            <li <?php if(isset($cur) && $cur=='found'){?>class="current"<?php }?>><a href="http://localhost/nn2/index.php/index/found" target="_blank">帮我找</a></li>
        </ul>
    </div>
</div>
                                    ...
                                    <p class="fenlei-h1"><?php echo isset($item['name'])?$item['name']:"";?></p><p class="fenlei">
                                        ...
                                        <?php for($num = 0 ; $num<=2 ; $num = $num+1){?>
                                            <?php if(isset($item['nested'][$num]['id'])){?>
                                                <a href="http://localhost/nn2/index.php/offers/offerlist/cate/<?php echo $item['nested'][$num]['id'];?>"><?php echo isset($item['nested'][$num]['name'])?$item['nested'][$num]['name']:"";?></a>&nbsp;
                                            <?php }?>
                                        <?php }?>
                                ...
                                <div class="item-list clearfix" style="top: 1px; display: none;">
                                    ...
                                    <div class="subitem">
                                        <?php if(!empty($item['nested'])) foreach($item['nested'] as $kk => $item){?>
                                            <?php if($kk<=11){?>
                                            <dl class="fore1">
                                                <dt><a href="http://localhost/nn2/index.php/offers/offerlist/cate/<?php echo $item['id'];?>"><?php echo isset($item['name'])?$item['name']:"";?></a></dt>

                                                <dd>
                                                    <?php if(!empty($item['nested'])) foreach($item['nested'] as $key => $item){?>
                                                        <em><a href="http://localhost/nn2/index.php/offers/offerlist/cate/<?php echo $item['id'];?>"><?php echo isset($item['name'])?$item['name']:"";?></a></em>
                                                    <?php }?>
                                                </dd>
                                            </dl>
                                            <?php }?>
                   ...
                   <!--人民币市场-->
                    ...
                    <div class="i_market_left" id="rmb_market">
                       ...
                       <!--         <li class="li_select" onclick="showOffers(1,$(this))"><a href="javascript:void(0)"><em></em><span></span>冶金化工市场</a></li>
                          ...
                          <span class="i_more"><a rel="http://localhost/nn2/index.php/offers/offerlist" href="http://localhost/nn2/index.php/offers/offerlist">更多&gt;&gt;</a></span>  
                        </div>
                            ...
                            <script language="javascript" type="text/javascript">
                                ...
                                function changeContainer(id){
                                    ...
                                    $('#container').highcharts({
                                        ...
                                        credits:{
                                            text:'耐耐网',
                                            href:'http://localhost/nn2/index.php/index/index'
                                        },
                                        subtitle: {
                    ...
                    <ul>
                        <?php if(!empty($fuwuList)) foreach($fuwuList as $key => $item){?>
                            <li class="iServiceTit">
                                ...
                                <div class="wi_fw"><a href="http://localhost/nn2/index.php/help/help/index?cat_id=<?php echo isset($item['cat_id'])?$item['cat_id']:"";?>&id=<?php echo isset($item['id'])?$item['id']:"";?>"><?php echo isset($item['name'])?$item['name']:"";?></a></div>
                            </li>
                        <?php }?>
                    </ul>
                </div>
        ...
        <li>
            ...
            <span class="i_w_10">
                <%if (data[i].quantity - data[i].sell - data[i].freeze>1) { %>
                    <%if (data[i].type==1) { %>
                        <a class="<%=data[i].id%>" href="http://localhost/nn2/index.php/offers/offerdetails/id/<%==data[i].id%>/pid/<%=data[i].product_id%>">
                            <img class="ckxq" src="/nn2/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/>
                        </a>
                     <a href="http://localhost/nn2/index.php/trade/check/id/<%=data[i].id%>/pid/<%=data[i].product_id%>">
                         <img src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="下单"/>
                     </a>
                    <%}else { %>
                        <a href="http://localhost/nn2/index.php/offers/purchasedetails/id/<%=data[i].id%>">
                            <img src="/nn2/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/>
                        </a>
                         <a href="http://localhost/nn2/index.php/trade/report/id/<%=data[i].id%>">
                              <img src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="下单"/>
                        </a>
                    <% } %>
                    <%}else { %>
                ...
                <?php if(!empty($helpList2)) foreach($helpList2 as $key => $item){?>
                    <li class="footer_li">
                        ...
                        <?php if(!empty($item['data'])) foreach($item['data'] as $k => $v){?>
                            ...
                            <?php }else{?>
                                <a class="fotter_a" href="http://localhost/nn2/index.php/help/help?cat_id=<?php echo isset($v['cat_id'])?$v['cat_id']:"";?>&id=<?php echo isset($v['id'])?$v['id']:"";?>" target="_blank"><?php echo isset($v['name'])?$v['name']:"";?></a>
