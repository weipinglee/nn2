     ...
     <!-- content start -->
            <div class="offer_content">
                ...
                <div class="offer_left">
                    ...
                    <div class="link_style">
                        <h5><a href="tencent://message/?uin=<?php echo isset($kefu['qq'])?$kefu['qq']:"";?>&Site=qq&Menu=yes"><img src="/nn2/views/pc/images/order/bj_kefu.png" alt="" /><span>联系客服</span></a></h5>
        ...
        <input type='hidden' name='user_type' value="<?php echo isset($user_type)?$user_type:"";?>">
                ...
                <div class="offer_right">
                    <ul>
                        <li>意向价：<b> <?php echo isset($data['price_l'])?$data['price_l']:"";?>~<?php echo isset($data['price_r'])?$data['price_r']:"";?></b>元/ <?php echo isset($data['unit'])?$data['unit']:"";?> <span class="qianse">（含税）</span></li>
                        <li>需求量： <i><?php echo isset($data['quantity'])?$data['quantity']:"";?></i>  <?php echo isset($data['unit'])?$data['unit']:"";?></li>
                    </ul>
                  ...
                  <!--  <div class="counter">
                    ...
                    <div class="buy_btn baoj">
                        <a href="#" id='buy_now' onclick="report('http://localhost/nn2/trade/report/id/<?php echo $data['id'];?>')" ><i><img src="/nn2/views/pc/images/order/bj_gm.png" alt="" /></i><b>立即报价</b></a>
                    </div>
                    <script type="text/javascript">
                        $(function(){
                ...
                <div class="cont_1">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>商品单价</td>
                            <td><?php echo isset($data['price_l'])?$data['price_l']:"";?>~<?php echo isset($data['price_r'])?$data['price_r']:"";?>/<?php echo isset($data['unit'])?$data['unit']:"";?></td>
                        </tr>
                        <tr>
