                       ...
                       <li class="but_left">
                           <div class="">
                               ...
                               <% if (data[i].jiao==0){ %>
								   ...
								   <a href="http://localhost/nn2/trade/check/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" no_cert="<%=data[i].no_cert%>" class="check_btn"><img style="vertical-align:middle;"  src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="下单"/></a>
                                    <% } else { %>
								   ...
								   <a href="http://localhost/nn2/trade/report/id/<%=data[i].id%>" no_cert="<%=data[i].no_cert%>" class='check_btn'><img style="vertical-align:middle;"  src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="报价"/></a>
