     ...
     <!-- content start -->
                ...
                <div class="offer_right">
                  ...
                  <!--  <div class="counter">
                    ...
                    <div class="buy_btn baoj">
                        <a href="http://localhost/nn2/trade/check/id/<?php echo $data['id'];?>/pid/<?php echo $data['product_id'];?>"><i><img src="/nn2/views/pc/images/order/bj_gm.png" alt="" /></i><b>立即购买</b></a>
            ...
            <div class="cont_1">
                ...
                <div class="clearfix">
                    ...
                    <img width="600" src="/nn2/views/pc/images/pro_show_img.jpg" /><a href="javascript:void(0);" onclick="picClose();">关闭</a>
                    </div>
                    <script>
