 ...
 <!------------------导航 开始-------------------->
           ...
           <div class="pro_classify">
            ...
            <div class="clearfix cla_sty">
                <input type="hidden" name="attr_url" value="http://124.166.246.120:8000/nn2/offers/ajaxgetcategory"  />
    ...
    <?php if($login==0){?>
        <div class="pro_gg">
            <div class="tit_center">
                <p><span class="title_big"><a href="http://124.166.246.120:8000/nn2/user/login/login"><u class="red">登录</u> </a>后可查看更多现货资源。</span><a href="http://124.166.246.120:8000/nn2/user/reg"><u class="red">点击这里免费注册</u></a>
                </p>
            </div>
        </div>
    <?php }?>
                       ...
                       <li class="but_left">
                           <div class="">
                               ...
                               <% if (data[i].jiao==0){ %>
                                   ...
                                   <a href="http://124.166.246.120:8000/nn2/offers/offerdetails/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;" src="/nn2/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/></a>
								   <a href="http://124.166.246.120:8000/nn2/trade/check/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;"  src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="下单"/></a>
                                    <% } else { %>
									<a href="http://124.166.246.120:8000/nn2/offers/purchasedetails/id/<%=data[i].id%>/pid/<%=data[i].product_id%>" ><img style="vertical-align:middle;"  src="/nn2/views/pc/images/icon/ico_sc1.png" class="ser_img" alt="查看详情"/></a>
								   <a href="http://124.166.246.120:8000/nn2/trade/report/id/<%=data[i].id%>" ><img style="vertical-align:middle;"  src="/nn2/views/pc/images/icon/ico_sc3.png" class="ser_img" alt="报价"/></a>
