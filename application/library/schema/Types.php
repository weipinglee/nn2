...
use schema\Type\CommentType;
use schema\Type\Enum\ContentFormatEnum;
use schema\Type\Enum\ImageSizeEnumType;
...
class Types
{
    ...
    {
        return self::$offer ?: (self::$offer = new OfferType());
    }
