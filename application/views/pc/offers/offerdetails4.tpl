...
<p class="h31" style="padding-bottom: 10px; padding-left:20px;font-size: 20px;">{$data['pro_name']}</p>
                <div class="left_img">
            ...
            <div class="left_center">
                <div class="offer">
                    <div class="offer_num">
                        ...
                        &nbsp;&nbsp;
                        <div style="height: 30px;line-height: 30px;">出价人:xxx</div>
                       <!--  <span>起订量：</span>
               ...
               <!--  
                ...
                <div class="add_jian" style="background: #f4f4f4;padding-top: 20px;">
                    <span>出价</span>
...
//计算总价
    ...
    //计算总价 end
                ...
                <div class="submit_but" style="background: #f4f4f4">
                    <input type="hidden" name="offer_id" value="{$data['id']}">
                    {if:$offerStatus==1}
                    <input class="but" type="submit" name="" disabled="disabled" value="即将开始">
                    {elseif:$offerStatus==2}
                    <input class="but" type="submit" name=""  value="竞价保证金">
                    {elseif:$offerStatus==3}
                    <input class="but but_bag" type="submit" name=""  value="已结束">
                    {/if}
                    <div style="padding: 10px ">提醒：先报名交保证金再出价。如果您已经支付保证金，请<a>登录</a></div>
                </div>
                <div class="auction_text clear">
                    <ul class="auction_ul">
                        <li><span>起拍价：￥{$data['price_l']}</span></li>
                        <li><span>保证金：800000</span></li>
                        <li><span>加价幅度：<i class="c816">￥10000</i></span></li>
                        <li><span>竞拍开始时间:</span></li>
                        <li><span>竞拍数量：</span></li>
                        <li><span>竞拍结束时间</span></li>
                    </ul>
                   
                </div>
                 <div>竞价规则：至少一人报名且出价，方可成交</div>
            </div>
