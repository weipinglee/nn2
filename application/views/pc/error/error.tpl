...
<section class="page-404 minWP text-c">
    ...
    <p style="display:none">{$errorMsg}</p>
    <p class="error-info">您可以：<a href="javascript:;" onclick="history.go(-1)" class="c-primary">&lt; 返回上一页</a><span class="ml-20">|</span><a href="{url:/index/index@deal}" class="c-primary ml-20">去首页 &gt;</a></p>
</section>
</body>
</html>
